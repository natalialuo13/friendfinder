...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="profile-header">
                <img src="../Img/hanni.jpg">
                <span class="date username"><?php echo $username; ?></span>
            </div>
            ...
            <div class="icon">
                ...
                <div class="heart">
                    ...
                    <span class="capt-header">Bersepeda</span>
                </div>
            </div>
    ...
    <div class="container-skill">
        <span class="header-skill">
            <p>Skill</p>
            <hr class="garis-bwh">
        </span>
        <div class="content-skill">
            <span class="skill">UI Design</span>
            <span class="skill">Multimedia</span>
